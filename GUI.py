        ...
        for cell_type, positions in cell_types_info:
            for position in positions:
                ...
                df = df.append({
                    "Sample Type": "Unknown",
                    "File Name": file_name,
                    "Sample ID": 1,  # Update with your logic if necessary
                    "Path": path,
...
def create_gui():
    ...
    # Load the logo image
    logo_path = '/Users/Pedarf/Desktop/Python scripts/qGenerator/250px-Arwing_Starlink.png'  # Replace with your local path
